...
GS_COLOR_IMAGE_RESOLUTION = max(1, env_int("GS_COLOR_IMAGE_RESOLUTION", 60))
GS_GRAY_IMAGE_RESOLUTION = max(1, env_int("GS_GRAY_IMAGE_RESOLUTION", 60))
GS_MONO_IMAGE_RESOLUTION = max(1, env_int("GS_MONO_IMAGE_RESOLUTION", 120))
