...
from pdf_compressor.core.exceptions import SplitError
from pdf_compressor.core.settings import get_delivery_runtime_settings
from pdf_compressor.core.utils import env_bool, env_choice, env_int, get_effective_cpu_count
...
def compress_parallel(
    ...
    from pdf_compressor.engine.split import merge_pdfs, split_by_pages, split_for_delivery
